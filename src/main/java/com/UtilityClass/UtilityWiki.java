...
public class UtilityWiki 
{
	...
	
	{
		...
		wbf = WorkbookFactory.create(file);
		  String ExpText = wbf.getSheet("Sheet1").getRow(2).getCell(0).getStringCellValue();
	...
	
	{
        ...
        file =new FileInputStream("B:\\eclipseworkspace\\IMDB\\TestData\\TestData.xlsx");
		wbf = WorkbookFactory.create(file);
		String ExpText1 = wbf.getSheet("Sheet1").getRow(2).getCell(1).getStringCellValue();
